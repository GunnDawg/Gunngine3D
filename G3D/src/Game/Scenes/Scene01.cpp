...
bool Scene01::On_load()
{
	...
	if (!Boxes[0].Load("WoodBox", "WoodBox", DirectX::XMFLOAT3{ -25.0f, 0.0f, 0.0f }))
		return false;

	if (!Boxes[1].Load("WoodBox", "WoodBox", DirectX::XMFLOAT3{ -20.0f, 0.0f, 0.0f }))
		return false;

	if (!Boxes[2].Load("WoodBox", "WoodBox", DirectX::XMFLOAT3{ -15.0f, 0.0f, 0.0f }))
		return false;

	if (!Boxes[3].Load("WoodBox", "WoodBox", DirectX::XMFLOAT3{ -10.0f, 0.0f, 0.0f }))
		return false;

	if (!Boxes[4].Load("WoodBox", "WoodBox", DirectX::XMFLOAT3{ -5.0f, 0.0f, 0.0f }))
		return false;

	if (!Boxes[5].Load("WoodBox", "WoodBox", DirectX::XMFLOAT3{ -25.0f, -5.0f, 0.0f }))
		return false;

	if (!Boxes[6].Load("WoodBox", "WoodBox", DirectX::XMFLOAT3{ -20.0f, -5.0f, 0.0f }))
		return false;

	if (!Boxes[7].Load("WoodBox", "WoodBox", DirectX::XMFLOAT3{ -15.0f, -5.0f, 0.0f }))
		return false;

	if (!Boxes[8].Load("WoodBox", "WoodBox", DirectX::XMFLOAT3{ -10.0f, -5.0f, 0.0f }))
		return false;

	if (!Boxes[9].Load("WoodBox", "WoodBox", DirectX::XMFLOAT3{ -5.0f, -5.0f, 0.0f }))
		return false;

	if (!Boxes[10].Load("WoodBox", "WoodBox", DirectX::XMFLOAT3{ -25.0f, -10.0f, 0.0f }))
		return false;

	if (!Boxes[11].Load("WoodBox", "WoodBox", DirectX::XMFLOAT3{ -20.0f, -10.0f, 0.0f }))
		return false;

	if (!Boxes[12].Load("WoodBox", "WoodBox", DirectX::XMFLOAT3{ -15.0f, -10.0f, 0.0f }))
		return false;

	if (!Boxes[13].Load("WoodBox", "WoodBox", DirectX::XMFLOAT3{ -10.0f, -10.0f, 0.0f }))
		return false;

	if (!Boxes[14].Load("WoodBox", "WoodBox", DirectX::XMFLOAT3{ -5.0f, -10.0f, 0.0f }))
		return false;

	if (!Boxes[15].Load("WoodBox", "WoodBox", DirectX::XMFLOAT3{ -25.0f, -15.0f, 0.0f }))
		return false;

	if (!Boxes[16].Load("WoodBox", "WoodBox", DirectX::XMFLOAT3{ -20.0f, -15.0f, 0.0f }))
		return false;

	if (!Boxes[17].Load("WoodBox", "WoodBox", DirectX::XMFLOAT3{ -15.0f, -15.0f, 0.0f }))
		return false;

	if (!Boxes[18].Load("WoodBox", "WoodBox", DirectX::XMFLOAT3{ -10.0f, -15.0f, 0.0f }))
		return false;

	if (!Boxes[19].Load("WoodBox", "WoodBox", DirectX::XMFLOAT3{ -5.0f, -15.0f, 0.0f }))
		return false;

	if (!Boxes[20].Load("WoodBox", "WoodBox", DirectX::XMFLOAT3{ -25.0f, -20.0f, 0.0f }))
		return false;

	if (!Boxes[21].Load("WoodBox", "WoodBox", DirectX::XMFLOAT3{ -20.0f, -20.0f, 0.0f }))
		return false;

	if (!Boxes[22].Load("WoodBox", "WoodBox", DirectX::XMFLOAT3{ -15.0f, -20.0f, 0.0f }))
		return false;

	if (!Boxes[23].Load("WoodBox", "WoodBox", DirectX::XMFLOAT3{ -10.0f, -20.0f, 0.0f }))
		return false;

	if (!Boxes[24].Load("WoodBox", "WoodBox", DirectX::XMFLOAT3{ -5.0f, -20.0f, 0.0f }))
		return false;
